...
public class Example {
  ...
  public void SMS(String phone) throws TwilioRestException {
      ...
      params.add(new BasicNameValuePair("Body", "My name is Shubham Yeole. This message is sent from Dr. Scharff Class. Thank you."));
